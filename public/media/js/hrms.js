...
function addDiv()
{
	...
	{	
		...
		html+="<div class='division'><textarea maxlength='500' cols='50' rows='10' id='description_"+idcount+"' name='description[]'></textarea></div>";
		html+="</div>";
...
function addAppQuestionDiv()
{
	...
	{	
		...
		html+="<div class='division'><input type='text' maxlength='500' value='' id='question_"+idcount+"' name='question[]' class='cls_service_request_name' onblur='validatequestionname(this)' onkeyup='validatequestionname(this)'></div>";
		html+="</div>";
		html+="<div class='new-form-ui clearb textareaheight'>";
		html+="<label>Description</label>";
		html+="<div class='division'><textarea maxlength='500' cols='50' rows='10' id='description_"+idcount+"' name='description[]'></textarea></div>";
	...
	{
		jAlert('You can add only 10 questions at a time.');
	}
