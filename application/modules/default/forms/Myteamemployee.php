...
class Default_Form_Myteamemployee extends Zend_Form
{
	public function init()
	{
        ...
        $complete_address->addFilter(new Zend_Filter_StringTrim());
        ...
        $emergency_contact->addFilter(new Zend_Filter_StringTrim());

        $last_attendance = new Zend_Form_Element_Text('last_attendance');
        $last_attendance->setAttrib('maxLength', 100);
        $last_attendance->setLabel("Last Attendance Record");
