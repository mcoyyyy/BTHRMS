...
class sapp_Helper 
{
    ...
    public static function service_header($data,$call)
    {
        ...
        $html .= '        <li class="acc_li"><span id="acc_li_toggle_'.SD_TRANS.'" class="acc_li_toggle" onclick="togglesubmenus('.SD_TRANS.')"><!--HRMS MODIFIED ***Commenting to remove my request summary in Service Request <b>My request summary</b>--></span>';
        $html .= '            <ul>';
                ...
                if($tot_rec_cnt > 0)
                {
                    for($i=2; $i <= $sizeOfWorksheet; $i++ )
                    {
                        ...
                        $data = array(  
                            ...
                            //HRMS MODIFIED
                            'complete_address'=>($rowData[18]!=''?$rowData[18]:NULL),
                            'emergency_contact'=>($rowData[19]!=''?$rowData[19]:NULL),
                            'last_attendance'=>($rowData[20]!=''?$rowData[20]:NULL),
...
<!--HRMS MODIFIED ***Changed from Policy Documents to Code of Discipline-->	<span>Code of Discipline</span> <span class="arrows">&rsaquo;</span> 
